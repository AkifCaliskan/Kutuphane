...
{
    public partial class asd135 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Operationss", x => x.OperationsID);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_Operationss_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "BookID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Operationss_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Operationss_BookId",
                table: "Operationss",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_Operationss_UserId",
                table: "Operationss",
                column: "UserId");
        }
