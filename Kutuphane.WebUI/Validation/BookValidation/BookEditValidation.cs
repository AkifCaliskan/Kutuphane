...
{
    public class BookEditValidation : AbstractValidator<BookEditModel>
    {
        public BookEditValidation()
        {
            ...
            RuleFor(x => x.SerialNumber).NotEmpty().WithMessage("Seri Numarası Boş Bırakılamaz");
            RuleFor(x => x.PageCount).NotEmpty().WithMessage("Sayfa Sayısı Boş Geçilemez");
